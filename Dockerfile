...
ARG IBM_API_KEY
ARG IBM_BUCKET_NAME
ARG IBM_BUCKET_INSTANCE_ID
ARG IBM_SERVICE_ENDPOINT
ARG COIN_GECKO_API_KEY

# Set environment variables (for use at runtime)
ENV TELEGRAM_BOT_TOKEN=${TELEGRAM_BOT_TOKEN}
ENV IBM_API_KEY=${IBM_API_KEY}
ENV IBM_BUCKET_NAME=${IBM_BUCKET_NAME}
ENV IBM_BUCKET_INSTANCE_ID=${IBM_BUCKET_INSTANCE_ID}
ENV IBM_SERVICE_ENDPOINT=${IBM_SERVICE_ENDPOINT}
ENV COIN_GECKO_API_KEY=${COIN_GECKO_API_KEY}
