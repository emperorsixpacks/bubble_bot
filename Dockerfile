...
RUN --mount=type=cache,id=6df28531-b778-4a87-b441-4b392717ce14-/var/cache/apt,target=/var/cache/apt \
...
RUN --mount=type=cache,id=6df28531-b778-4a87-b441-4b392717ce14-${UV_CACHE_DIR},target=${UV_CACHE_DIR} \
    pip install --upgrade uv

# Install Playwright and Chromium
RUN --mount=type=cache,id=6df28531-b778-4a87-b441-4b392717ce14-/root/.cache/playwright,target=/root/.cache/playwright \
    uv add playwright && \
